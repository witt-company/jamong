...
export const portfolioData: PortfolioProject[] = [
  ...
  },
  {
    ...
    description: "시민들이 직접 지역 현안에 참여하고 의견을 제시할 수 있는 모바일 플랫폼 개발 예정입니다.",
    features: [
      "실시간 설문조사",
      "지역 이슈 제보",
      "시민 토론방",
  ...
  },
  {
    ...
    description: "도시 교통 데이터를 실시간으로 분석하여 교통 정책 수립에 도움을 주는 대시보드 개발 예정입니다.",
    features: [
      "실시간 교통량 모니터링",
      "교통 패턴 분석",
      "사고 다발 지역 예측",
  ...
  },
  {
    ...
    description: "블록체인 기술을 활용하여 안전하고 투명한 디지털 신원 인증 시스템 개발 예정입니다.",
    features: [
      "분산 신원 인증",
      "스마트 계약 기반 검증",
      "개인정보 보호",
